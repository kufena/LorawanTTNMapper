...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x03, 0xA1, 0xAF }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x91, 0x5C, 0xE6, 0xDF, 0xF8, 0x83, 0x37, 0xCA, 0x93, 0x18, 0xD7, 0x55, 0x32, 0x3A, 0xFE, 0x3C } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x00, 0x73, 0x76, 0xEA, 0x6B, 0x10, 0xFF, 0xD5 }                                                 // set by application[*]
